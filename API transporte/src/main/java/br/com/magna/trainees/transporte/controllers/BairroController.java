...
public class BairroController extends GenericController {
    ...
    @ApiResponse(responseCode = "200", description = "Bairros encontrados com sucesso",
    ...
    @ApiResponse(responseCode = "200", description = "Bairro encontrado com sucesso",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = BairroModel.class)))
    ...
    @ApiResponse(responseCode = "201", description = "Bairro salvo com sucesso",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = BairroModel.class)))
    @PostMapping("/")
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> put(@PathVariable Long id, @Valid @RequestBody BairroDto bairroDto, BindingResult result){
        Optional<BairroModel> optionalBairro = bairroService.findById(id);
