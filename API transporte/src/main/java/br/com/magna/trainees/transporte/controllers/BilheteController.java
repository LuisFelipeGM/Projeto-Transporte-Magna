...
public class BilheteController extends GenericController {
	...
	@ApiResponse(responseCode = "200", description = "Bilhetes encontrados com sucesso", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = BilheteModel.class))))
	@GetMapping("/")
	...
	@ApiResponse(responseCode = "200", description = "Bilhete encontrado com sucesso", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = BilheteModel.class))))
	...
	@ApiResponse(responseCode = "201", description = "Bilhete gerado com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BilheteModel.class)))
	@PostMapping("/")
	...
	public ResponseEntity<Object> delete(@PathVariable Long id) {
		...
		return optionalBilhete.map(bilhete -> {
