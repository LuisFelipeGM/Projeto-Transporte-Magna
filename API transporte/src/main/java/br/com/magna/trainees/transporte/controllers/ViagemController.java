...
public class ViagemController extends GenericController {
	...
	@ApiResponse(responseCode = "200", description = "Viagens encontradas com sucesso", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = ViagemModel.class))))
	@GetMapping("/")
	...
	@ApiResponse(responseCode = "200", description = "Viagem encontrada com sucesso", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = ViagemModel.class))))
	...
	@ApiResponse(responseCode = "201", description = "Viagem salva com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ViagemModel.class)))
	@PostMapping("/")
	...
	public ResponseEntity<Object> delete(@PathVariable Long id) {
		...
		return optionalViagem.map(viagem -> {
