...
public class BairroService extends EntityService<BairroModel>{
    ...
    BairroService(JpaRepository<BairroModel, Long> repository, BairroRepository bairroRepository, CidadeRepository cidadeRepository) {
        super(repository);
    ...
    public BairroModel adicionaBairro(BairroDto bairroDto){
        try {
            Optional<CidadeModel> cidadeOptional = cidadeRepository.findById(bairroDto.idCidade());
