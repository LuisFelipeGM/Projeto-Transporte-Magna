...
public class BairroControllerTest {
    ...
    @After
    @Transactional
    public void redefinirSequencia() {
        entityManager.getTransaction().begin();
        entityManager.createNativeQuery("DELETE FROM transporte.TB_BAIRRO").executeUpdate();
        entityManager.createNativeQuery("ALTER SEQUENCE tb_bairro_id_seq RESTART WITH 1").executeUpdate();
    ...
    */
    ...
    public void testCadastrandoUmBairroComIdCidadeValido(){
        ...
        ResponseEntity<BairroModel> response = restTemplate.postForEntity(
                "http://localhost:" + randomServerPort + "/bairro/",
                bairro,
                BairroModel.class);
    ...
    public void testListarUmBairroComIdValido() {
        ResponseEntity<BairroModel> response = restTemplate.getForEntity(
                "http://localhost:" + randomServerPort + "/bairro/1",
                BairroModel.class
        );
    ...
    public void testLitarUmBairroComIdInvalido() {
        ResponseEntity<BairroModel> response = restTemplate.getForEntity(
                "http://localhost:" + randomServerPort + "/bairro/200",
                BairroModel.class
        );
    ...
    /*
    @Test
    @DisplayName("Deveria encontrar um bairro a partir do seu nome")
    public void testListarUmBairroAPartirDoSeuNome(){
        ResponseEntity<BairroModel> response = restTemplate.getForEntity(
                "http://localhost:" + randomServerPort + "/bairro/nome/Jardim%20Helena",
                BairroModel.class
        );
    ...
    */
    ...
    public void testAtualizarUmBairroComNomeNulo(){
        ...
        try {
            restTemplate.put("http://localhost:" + randomServerPort + "/bairro/1", request);
    ...
    public void testAtualizarUmBairroComIdBairroInvalido(){
        ...
        try {
            restTemplate.put("http://localhost:" + randomServerPort + "/bairro/1000", request);
        } catch (HttpClientErrorException e) {
            HttpStatusCode statusCode = e.getStatusCode();
            Assert.assertEquals(HttpStatus.NOT_FOUND, statusCode);
        }
    ...
    public void testDeletaUmBairroComIdInvalido(){
        ResponseEntity<BairroModel> response = restTemplate.exchange(
                "http://localhost:" + randomServerPort + "/bairro/5",
                HttpMethod.DELETE,
                null,
                BairroModel.class
        );
