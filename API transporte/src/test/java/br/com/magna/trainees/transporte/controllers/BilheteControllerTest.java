...
public class BilheteControllerTest {
	...
	public void testUtilizarBilheteComIdValido() {
		ResponseEntity<BilheteModel> response = restTemplate.exchange(
				"http://localhost:" + randomServerPort + "/bilhete/1", HttpMethod.PUT, null,
				BilheteModel.class);
	...
	public void testUtilizarBilheteComIdInvalido() {
		ResponseEntity<BilheteModel> response = restTemplate.exchange(
				"http://localhost:" + randomServerPort + "/bilhete/100", HttpMethod.PUT, null,
				BilheteModel.class);
	...
	public void testDeletaUmPassageiroComIdValido() {
		ResponseEntity<BilheteModel> response = restTemplate.exchange(
				"http://localhost:" + randomServerPort + "/bilhete/1", HttpMethod.DELETE, null,
				BilheteModel.class);
	...
	public void testDeletaUmPassageiroComIdInvalido() {
		ResponseEntity<BilheteModel> response = restTemplate.exchange(
				"http://localhost:" + randomServerPort + "/bilhete/100", HttpMethod.DELETE, null,
				BilheteModel.class);
